      ...
      type constituent_mass
        ...
        real, dimension (:), allocatable :: poll      !ICRA pollutants in hidrograph
     ...
     type constituents_header_in          
      ...
      function hydcsout_add (hydcs1, hydcs2) result (hydcs3)
        ...
        allocate (hydcs3%poll(cs_db%num_poll))  !ICRA
      ...
      function hydcsout_mult_const (const, hydcs1) result (hydcs2)
        ...
        integer :: ipest, ipath, ihmet, isalt, ipoll !ICRA
        ...
        allocate (hydcs2%poll(cs_db%num_poll))  !ICRA
